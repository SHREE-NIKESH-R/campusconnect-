...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen mesh-bg flex items-center justify-center p-4">
      <div className="fixed top-0 right-0 w-96 h-96 rounded-full opacity-25 blur-3xl pointer-events-none"
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Join CampusConnect today</p>
        </div>
        ...
        <div className="glass-lg rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input label="Full Name" placeholder="Arjun Krishnan" icon={User}
              value={form.fullName} onChange={set('fullName')} required />

            <Input label="Email" type="email" placeholder="you@campus.edu" icon={Mail}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Input label="Student ID" placeholder="CS2024001" icon={Hash}
                value={form.studentId} onChange={set('studentId')} />
            </div>

            <div className="grid grid-cols-2 gap-3">
              <Input label="Phone" placeholder="+91 9000000000" icon={Phone}
